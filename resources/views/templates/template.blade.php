        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Contato<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li><a href="alugue1neto">Alugue um Neto<span class=" animated bounceInLeft a1n-novo"><h4>Novo</h4></span></a></li></li>  
                    <li class="dropdown login-assiz">
                            @if (Auth::guest()) <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Login<span class="caret"></span></a>
                                <ul class="dropdown-menu">
